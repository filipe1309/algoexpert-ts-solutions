...
echo -e "👉 You are about to create a new ${GREEN}${BOLD}solution ${NEW_SOLUTION_NUMBER}${NC} for ${GREEN}${BOLD}${NAME_SNAKE}${NC} challenge in ${GREEN}${BOLD}${LEVEL_LOWERCASE}${NC} level."
